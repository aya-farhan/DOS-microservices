...
# this micro service manipulate db thorough put method and query db using get, using this microservice we can query,
# ask for info and update
...
def info(book_id):
    ...
    return jsonify(({"item number": post['id'], "title": post['name'], "topic": post['topic'],
